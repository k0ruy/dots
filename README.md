...
Some general info (switched to linux mint and sway, old arch stuff is kinda gone. or at least archived):
* This customization really was inspired a lot by [https://github.com/Ruixi-rebirth/sway-dotfiles](https://github.com/Ruixi-rebirth/sway-dotfiles), so many config files are similar and also the overall look. 
* Current wallpaper is `sway_dynamic_wallpapers/wallhaven-knight.jpg`.
...
## Showcasing desktop
*Desktop with nvim, btop++ and wezterm terminal running `cbonsai`:*
